...
{
    [Fact]
    public void GetInvalidSum_WhenOneRange_ReturnsCorrectSum()
    {
        var ranges = new List<(ulong from, ulong to)> { (11, 22) };

        var sum = Day2.GetInvalidSum(ranges);

        sum.Should().Be(33);
    }
    
    [Fact]
    public void GetInvalidSum_WhenMultipleRanges_ReturnsCorrectSum()
    {
    ...
    [Fact]
    public void GetInvalidSum_WhenDay2Part1Input_ReturnsCorrectSum()
    {
